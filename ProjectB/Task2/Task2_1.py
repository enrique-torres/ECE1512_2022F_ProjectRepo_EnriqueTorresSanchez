...
from utils import get_network, get_daparam, get_time, TensorDataset, epoch, ParamDiffAug
import platform
...
def main():
    ...
    images_trajectory_matching_images = "..\\Task_2\\logged_files\\CIFAR10\\fancy-brook-15\\images_best.pt"
    labels_trajectory_matching_images = "..\\Task_2\\logged_files\\CIFAR10\\fancy-brook-15\\labels_best.pt"
