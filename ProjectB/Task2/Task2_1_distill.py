...
from utils import get_dataset, get_network, get_eval_pool, evaluate_synset, get_time, DiffAugment, ParamDiffAug, get_daparam
import wandb
import copy
import random
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pix_init', type=str, default='gnoise', choices=["noise", "real", "gnoise"],
